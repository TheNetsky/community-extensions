import { Chapter, ChapterDetails, PagedResults, PartialSourceManga, SearchField, Tag, TagSection } from "@paperback/types"
import { decodeHTMLEntity, isLastPage, parseDate } from "./Hentai2ReadHelper"
import { categories, getTagId, tags, populateTags } from "./Hentai2ReadTags"
import { DOMAIN } from "./Hentai2Read"

export let nextSearchPageUrl: string = ''

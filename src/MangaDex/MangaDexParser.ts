...
export const parseChapterList = async (chapterObject: any, coversMapping: { [id: string]: string }, source: any, thumbnailSelector: any, ratings: string[]): Promise<PartialSourceManga[]> => {
    const results: PartialSourceManga[] = []
